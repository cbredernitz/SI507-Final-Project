...
class Testing_Import_files(unittest.TestCase):
    ...
    def test_files_renamed(self):
        self.assertTrue(self.reddit.read(), "Change name of 'reddit_secret_sample.py' to 'reddit_secret.py'")
        self.assertTrue(self.config.read(), "Change name of 'config_sample.py' to 'config.py'")

    def test_reddit_creds(self):
        self.assertNotEqual(client_id, "", "Make sure to fill in client_id on file called reddit_secret")
        self.assertNotEqual(client_secret, "", "Make sure to fill in client_secret on file called reddit_secret")
        self.assertNotEqual(username, "", "Make sure to fill in your reddit username on file called reddit_secret")
        self.assertNotEqual(password, "", "Make sure to fill in your reddit account password on file called reddit_secret")

    def test_config_creds(self):
        self.assertNotEqual(db_name, "", 'Fill in db_name in config file')
        self.assertNotEqual(db_user, "", 'Fill in db_name in config file')
